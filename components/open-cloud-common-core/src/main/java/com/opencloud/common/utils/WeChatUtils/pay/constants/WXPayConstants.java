package com.opencloud.common.utils.WeChatUtils.pay.constants;
...
public class WXPayConstants {
     ...
     */
    @Value("${wxopen_appid}")
    public static String APP_ID; // 真实
    public static String APP_ID_XXX = "xxx"; // 测试/第二个账号

    /**
     * AppSecret
     */
    public static String SECRET; // 真实
    ...
    public static final String TRADE_TYPE_HTML5 =  "MWEB";
    ...
    public static final String ERR_CODE_NOAUTH = "NOAUTH";
}
