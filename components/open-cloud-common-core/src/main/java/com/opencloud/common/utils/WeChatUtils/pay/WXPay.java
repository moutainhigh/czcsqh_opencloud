package com.opencloud.common.utils.WeChatUtils.pay;


import com.opencloud.common.utils.WeChatUtils.pay.constants.WXPayConstants;
import com.opencloud.common.utils.WeChatUtils.pay.util.DateTimeUtil;
import com.opencloud.common.utils.WeChatUtils.pay.util.WXPayUtil;
...
public class WXPay {
    ...
    public WXPay(final WXPayConfig config, final String notifyUrl, final boolean autoReport, final boolean useSandbox) throws Exception {
        ...
        if (useSandbox) {
            ...
            this.signType = WXPayConstants.SignType.MD5; // 此处原来不是MD5！！！
        }
    ...
    public Map<String, String> unifiedOrder(String notify_url, String openid, String body, String out_trade_no, String total_fee,
        ...
        data.put("trade_type", WXPayConstants.TRADE_TYPE_HTML5);
        ...
        //场景信息 scene_info 是 String(256)   {"h5_info": {"type":"Android","app_name": "王者荣耀","package_name": "com.tencent.tmgp.sgame"}}
        data.put("scene_info","{\"h5_info\":{\"type\":\"Android\",\"app_name\":\"糖奈斯\",\"package_name\":\"plus.H54F7F245\"} }");
        /** 以下参数为非必填参数 **/
